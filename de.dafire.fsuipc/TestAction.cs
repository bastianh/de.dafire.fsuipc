...
{
    [PluginActionId("de.dafire.fsuipc.test")]
    ...
    public class TestAction : PluginBase
    {
        ...
        {
            if (settings != null && settings.Connected != _testState)
            {
                settings.Connected = _testState;
                SaveSettings();
            }
        }
        ...
        public override void KeyPressed(KeyPayload payload)
        {
            ...
            Logger.Instance.LogMessage(TracingLevel.INFO, "teststate toggled " + _testState);
        }
